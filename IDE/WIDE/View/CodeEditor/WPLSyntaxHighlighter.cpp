#include "WPLSyntaxHighlighter.hpp"

WPL_Syntax_Highlighter::WPL_Syntax_Highlighter(QTextDocument *parent)
...
void WPL_Syntax_Highlighter::highlightBlock(const QString &text)
{
